...
const RUTAS = [
  "/",
  "/tratamientos",
  "/tratamientos/diseno-de-sonrisa",
  "/tratamientos/carillas-de-porcelana",
  "/tratamientos/blanqueamiento-dental",
  "/tratamientos/coronas-dentales",
  "/tratamientos/incrustaciones-ceramicas",
  "/tratamientos/incrustaciones-de-resina",
  "/tratamientos/cambio-de-amalgamas",
  "/tratamientos/implantes-unitarios",
  "/tratamientos/rehabilitacion-sobre-implantes",
  "/tratamientos/alineadores-invisibles",
  "/tratamientos/brackets",
  "/tratamientos/tratamiento-de-conducto",
  "/tratamientos/postes-y-reconstruccion",
  "/tratamientos/extracciones-dentales",
  "/tratamientos/frenectomia-laser",
  "/tratamientos/gingivectomia-laser",
  "/tratamientos/retracciones-gingivales",
  "/tratamientos/limpieza-profunda",
  "/tratamientos/restauraciones-caries",
  "/casos",
